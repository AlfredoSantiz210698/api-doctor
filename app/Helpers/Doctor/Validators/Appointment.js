...
class Appointment {
    ...
    static create(form){
        return validate(form, {
            ...
            'full_name.required': 'Nombre del paciente requerido.',
            'full_name.string': 'El nombre del paciente debe ser solo letras.',
            'full_name.max': 'El nombre del paciente supera el tamaño permitido.',
